# This is a fork for Raynes/tentacles
This fork simply updates the otherwise working API to use deps.edn, as well as
updating to the latest stable version of dependencies.
